...
const EditForm = () => {
    ...
    const [openCoverModal] = useModal('ADD_COVER-MODAL');
    const [openAvatarModal] = useModal('CHANGE-AVATAR-MODAL');
    ...
    return (
        <div className="EditForm">
            <div className='profile-cover'
                style={{ 'backgroundImage': `url(${STATIC_COVER_URL(user.coverImage)})` }}>
            ...
            <div className='EditForm-content'>
                ...
                <button onClick={openAvatarModal} className='openModalBtn'>
